    ...
    <nav className="w-full bg-[#1a1a1a] border-b border-[#2a2a2a]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-[70px]">
          ...
          <a href="#home" className="flex items-center gap-2 flex-shrink-0">
            ...
            <div className="w-10 h-10 flex items-center justify-center">
              ...
              >
                {/* Outer house border */}
                <polygon
                  points="24,4 44,20 44,44 4,44 4,20"
                  stroke="#C9A227"
                  strokeWidth="2.5"
                  fill="none"
                />
                {/* Inner house (smaller, inset) */}
                <polygon
                  points="24,12 38,23 38,40 10,40 10,23"
                  stroke="#C9A227"
                  strokeWidth="2"
                  fill="none"
                />
            ...
            <div className="leading-tight">
              <div className="text-[#C9A227] font-bold text-lg tracking-widest uppercase">
                RAJULA'S
              </div>
              <div className="text-white text-[10px] tracking-[0.35em] uppercase font-light -mt-0.5">
                INTERIOR
              </div>
            </div>
          </a>
          ...
          >
            <span
              className={`block w-6 h-0.5 bg-[#C9A227] transition-all duration-300 ${
